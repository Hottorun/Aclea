          ...
          <div className="flex flex-wrap gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="h-9 w-full sm:w-56 rounded-lg border border-border bg-background pl-9 pr-4 text-sm text-foreground placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring/30"
              />
            </div>
            ...
            <div className="flex gap-2">
              <select
                ...
                className="h-9 rounded-lg border border-border bg-background px-3 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring/30"
              >
